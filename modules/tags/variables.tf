variable "mandatory" {
  description = <<-EOT
    ...
    PLACEHOLDER KEYS — pending confirmation of the authoritative mandatory tag
    schema (LLD Open Item 3). Update this object's keys (and callers) once the
    bank standard is confirmed.
